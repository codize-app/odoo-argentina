...
class ImportPadronSircarNeuquen(models.Model):
    _name = 'import.padron.sircar.neuquen'
    _description = 'import.padron.sircar.neuquen'
        ...
        for i,line in enumerate(lines):
            ...
            if len(lista) > 10:
                ...
                if tipo == 'P' or tipo == 'R': 
                    ...
                    padron_existe = self.env['sircar.neuquen.padron'].search([('name','=',cuit)])
                    if len(padron_existe) > 0:
                        ...
                        self.env['sircar.neuquen.padron'].sudo().create(vals)
                    _procesados += "{} \n".format(cuit)
