            ...
            if self.invoice_line_ids:
                if self.partner_id:
                    if len(self.partner_id.alicuot_per_arba_ids) > 0:
                        ...
                        # Cambio el amount del impuesto por el valor que tenga el partner en el padron, guardo el valor del impuesto
                        # para luego volverlo a su estado inicial
                        _valor_anterior = imp_per_arba.amount
                        #self.partner_id.imp_per_arba_ids[0].tax_id.amount = self.partner_id.alicuot_per_arba_ids[0].a_per
                        ...
                        # Vuelvo el amount del impuesto a su estado inicial
                        imp_per_arba.amount = _valor_anterior
